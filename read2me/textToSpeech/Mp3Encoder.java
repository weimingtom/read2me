...
public class Mp3Encoder extends Thread {
	...
	public Mp3Encoder(String path, String quality){
		this.path=path;
	...
	public void encodeMP3(String path, String quality) throws java.io.IOException, java.lang.InterruptedException{
		//try {
		...
		for (int i = firstFileIndex; i < encodeArgs.length; i++) {
			long time = System.currentTimeMillis();
			//int bytes = writeFile(args[i]);
			int bytes = writeFile(encodeArgs[i]);
